export const config = {
	mapTitle: 'average-labour-tax', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-average-labour-taxes.vercel.app/', // The url provided when deploying the map on Vercel
